...
class MyCheckBox {
  constructor(checks, noneCheck, maxSelection) {
    ...
    // TODO[gaurav] Mainfunction name change
      this.checks[i].addEventListener('click',this.dayCheckBoxHandler.bind(this))
    }
  ...
  printMsg() {
    ...
    alert(`Only ${this.maxSelection} days can be selected You have already selected ${string} `)
  }
